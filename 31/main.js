...
var regex11 = /hi*/g;						//string that contains zero or more occurrences of a character
var result14 = teksti3.match(regex11);
console.log(result14);

var regex12 = /hi?/g;						//string that contains zero or one occurrence of a character
var result15 = teksti3.match(regex12);
console.log(result15);

var regex13 = /o{2}/g;
var result16 = teksti2.match(regex13);
console.log(result16)


teksti4 = "runing, playing, and having fun! << testing";
